...
CREATE TABLE IF NOT EXISTS `vetl`.`tbl_facility` (
  ...
  `hazard_category_id` INT NULL COMMENT '',
  ...
  INDEX `fk_tbl_facility_tbl_hazard_category1_idx` (`hazard_category_id` ASC)  COMMENT '',
  INDEX `fk_tbl_facility_tbl_locality1_idx` (`locality_id` ASC)  COMMENT '',
  INDEX `fk_tbl_facility_tbl_brigada1_idx` (`brigada_id` ASC)  COMMENT '',
  CONSTRAINT `fk_tbl_facility_tbl_hazard_category1`
    FOREIGN KEY (`hazard_category_id`)
    REFERENCES `vetl`.`tbl_hazard_category` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_facility_tbl_locality1`
    FOREIGN KEY (`locality_id`)
    REFERENCES `vetl`.`tbl_locality` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_facility_tbl_brigada1`
